import {PoDynamicModule, PoLoadingModule, PoModalModule, PoPageModule} from "@po-ui/ng-components";
...
export class CharactersManagementsComponent {
  ...
  readonly breadcrumb: PoBreadcrumb = {
    items: [{ label: 'Lista de Personagens Favoritos'}]
  };
